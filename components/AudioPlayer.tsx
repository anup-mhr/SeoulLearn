...
// Separate component for audio to handle hooks properly
function AudioPlayer({ url }: { url: string }) {
    ...
    const { currentTime, duration, playing } = audioStatus;
    ...
    return (
        <View style={styles.mediaContainer}>
            ...
            <View style={styles.audioControls}>
                ...
                >
                    <Text style={[styles.audioControlIcon, styles.primaryControlIcon]}>
                        {playing ? "⏸" : "▶"}
                    </Text>
                    <Text style={[styles.audioControlText, styles.primaryControlText]}>
                        {playing ? "Pause" : "Play"}
                    </Text>
                </TouchableOpacity>
